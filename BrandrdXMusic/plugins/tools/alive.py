    ...
    await message.reply_video(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton(
                text="☆ ʙʀᴀɴᴅᴇᴅ 💗 ", url=f"https://t.me/WTF_SUSANT_BHAI"
            ),
            InlineKeyboardButton(
                text="☆ ꜱᴜᴘᴘᴏʀᴛ 💗", url=f"https://t.me/DragonByteGc"
            ),
        ],
                [
            InlineKeyboardButton(
                text="☆ ᴄʜᴀɴɴᴇʟ💗", url=f"https://t.me/SusantxBotz"
            ),
                ],
                [
                    InlineKeyboardButton(
                        "✯ Yo✯", callback_data="close"
                    )
                ],
            ]
        )
